...
<body>
	...
	<div class="cafe_cnt">카페<span class="total_cnt">${pageMaker.total }</span></div>
...
<script>	
    ...
    $(".pageInfo a").on("click", function(e){
    	  ...
    	  var url = "/cafe?c=" + category + "&pageNum=" + pageNum; // 카테고리 파라미터와 페이지 번호를 포함한 URL 구성
