...
<body>
	...
	<div class="hobby_cnt">취미<span class="total_cnt">${pageMaker.total }</span></div>
...
<script>	
    ...
    $(".pageInfo a").on("click", function(e){
    	  ...
    	  var url = "/hobby?c=" + category + "&pageNum=" + pageNum; // 카테고리 파라미터와 페이지 번호를 포함한 URL 구성
