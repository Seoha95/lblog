...
<body>
	...
	<div class="travel_cnt">여행<span class="total_cnt">${pageMaker.total }</span></div>
...
<script>	
	let moveForm = $("#moveForm4");
 
	$(".move").on("click", function(e) {
	    e.preventDefault();
	    var bno = $(this).attr("href"); // href 속성의 값인 bno 가져오기
	    var url = "/get?bno=" + encodeURIComponent(bno); // bno 값을 인코딩하여 URL에 포함

	    window.location.href = url; // URL로 페이지 이동
	});
    ...
    $(".pageInfo a").on("click", function(e){
    	  ...
    	  var url = "/travel?c=" + category + "&pageNum=" + pageNum; // 카테고리 파라미터와 페이지 번호를 포함한 URL 구성
